...
function ModBenchmarks() {
  ...
  const jugadoresLiga=useMemo(()=>{if(!dbPro)return[];return dbPro.jugadores.filter(j=>{const ml=j.l&&j.l===ligaNombre;const mc=equipo==="__todos__"||j.eq===equipo;return ml&&mc&&posAC(j.pos)===posAC(pos)&&j.s?.rat;});},[dbPro,pais,div,equipo,pos,ligaNombre]);
